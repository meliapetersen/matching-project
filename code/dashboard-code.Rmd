...
png( )
  ...
  tmap_mode("plot")
  tmap_style("cobalt")
  tm_shape( phoenix-mesa-scottsdale-az-dorling-v1.geojson, bbox=bb ) + 
...
city.dorling <- get_dorling( input$city.name )




#city.dorling <- reactive{{

#get_dorling( input$city.name )
...
fluidPage(
  ...
  radioButtons("radio", label = h3("Radio buttons"),
    choices = list("Phoenix, AZ" = 38060, "Boulder, CO" = 14500, "New Orleans, LA" = 35380, "Reno, NV" = 39900, "New York, NY" = 35644 ), 
    selected = 38060),
