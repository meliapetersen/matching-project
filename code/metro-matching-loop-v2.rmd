...
build_colored_map <- function( matchit.object, dorling.object )
...
```{r}
colored.map <- build_colored_map( matchit.object, dorling.object )
```
...
for( i in cbsa.list )
{
   ...
   build_colored_map( matchit.object=matchit.model, dorling.object=dorling.object.i)
