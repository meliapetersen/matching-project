...
h4( HTML( "Upload the .csv you just downloaded on Tab 1, and aggregate it to the census tract level." ) )
  ...
  merged.data <- 
    ...
    # NEW CODE  
     #left_join( treat.data, df.merged.treatment, by.x = "tractid", by.y = "id2", all.x = TRUE )
      ...
      merge(treat.data, df.merged.treatment, by.x = "tractid", by.y = "id2", all.x = TRUE)
